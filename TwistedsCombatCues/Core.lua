...
TCC.FONTS = {
    ...
    { key = "ARIALBOLD",   label = "Arial Bold",        path = FDIR .. "Arial Bold.TTF" },
    { key = "ARIALNARROW", label = "Arial Narrow",      path = FDIR .. "Arial Narrow.ttf" },
    { key = "AVANTGARDE",  label = "Avant Garde Naowh", path = FDIR .. "Avant Garde Naowh.ttf" },
